...
export const useDataTableColumnComponent = () => {
  ...
  const DataTableColumnComponent: ComponentConfig<DataTableColumnProps> = useMemo(() => {
    ...
    const component: ComponentConfig<DataTableColumnProps> = {
      ...
      displayName: t('dataTableColumn.name'),
      category: 'Hidden',
      subcategory: 'Input',
      icon: '',
      description: t('dataTableColumn.description'),
      ...
      fields: {
        ...
        asActionColumn: { subsection: 'General', label: t('property.actionColumn'), type: 'checkbox' },
        actionColumnAsMenu: {
          subsection: 'Content',
          label: t('property.groupActions'),
          type: 'checkbox',
        ...
        filterable: {
          subsection: 'General',
          label: t('property.enableFiltering'),
          type: 'checkbox',
          hide: data => data.asActionColumn
        },
