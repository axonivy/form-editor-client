...
export const useBase = () => {
  ...
  const baseComponentFields: Fields<BaseComponentProps> = {
  ...
  const visibleComponentField: Fields<VisibleItemProps> = {
    visible: {
  ...
  const disabledComponentFields: Fields<DisabledItemProps> = {
  ...
  const behaviourComponentFields: Fields<BehaviourItemProps> = {
  ...
  const selectItemsComponentFields: Fields<SelectItemsProps> = {
    label: {
      subsection: 'General',
      label: 'Label',
      type: 'textBrowser',
