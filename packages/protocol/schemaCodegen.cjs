...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/release%252F12.0/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.dialog.form.lsp.schema/target/schema/form/12.0.2/form-tsgen.json';
